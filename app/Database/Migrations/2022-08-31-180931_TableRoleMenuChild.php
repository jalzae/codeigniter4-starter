...
class TableRoleMenuChild extends Migration
{
    public function up()
    {
        $fields = [
            "id" => ["type" => "INT", "constraint" => 11, "null" => false, "auto_increment" => true,],
            "id_primmary_menu" => ["type" => "INT", "constraint" => 11, "null" => false,],
            ...
            "is_active" => ["type" => "ENUM", "constraint" => ['1', '0'], "null" => false, "default" => "1",],
        ...
        $this->forge->createTable("role_menu_child", false, $attributes);
    }
    public function down()
    {
        return $this->db->query("DROP TABLE `role_menu_child`");
    }
}
